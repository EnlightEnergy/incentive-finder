...
- **Data Integration**: Utilizes `utility_zip_codes` table for territory identification (4,368 California ZIP-to-utility mappings) and `chat_conversations` for persistent history. Real-time program matching based on location and facility type.
- **User Flow**:

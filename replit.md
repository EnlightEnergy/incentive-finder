...
- **Hero Section**: Updated title to "Unlock utility, state, and federal programs your facility can use for energy efficiency upgrades." Replaced gradient background with blue cityscape image (`/attached_assets/Incentive_background_1760128727694.png`) with 35% dark overlay for text readability. Changed all hero text (kicker, title, subtitle) to white. Hero section contains ONLY the text content - search form moved to separate white section below. Removed "Get my Incentive Report" CTA button.
